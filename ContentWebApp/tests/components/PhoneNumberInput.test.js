...
import { PhoneNumberInput } from "../../src/components/AllContent/shared/PhoneNumberInput";
...
describe("PhoneNumberInput", () => {
  ...
  test("displays controlled value", () => {
    const onChange = jest.fn();
    render(<PhoneNumberInput value="9876543210" onChange={onChange} />);
    const input = screen.getByRole("textbox", { name: /phone number/i });
