...
jest.mock("./AddQuiz", () => () => <div data-testid="add-quiz">AddQuiz Component</div>);
jest.mock("./AddStory", () => ({ contentType }) => <div data-testid="add-story">AddStory Component: {contentType}</div>);
