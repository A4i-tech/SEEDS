    ...
    <div className="mng">
      ...
      {dlg ? (
        ...
        >
          ...
          />
          <div className="modal-actions">
            <button type="button" className="action-ghost-button" onClick={() => setDlg(null)}>
              Cancel
            </button>
            <button type="button" className="primary-button" onClick={save} disabled={!dlg.values.name.trim()}>
              Save
            </button>
          </div>
        </Modal>
      ...
      {dlg ? (
        ...
        >
          ...
          <div className="modal-actions">
            ...
            <button type="button" className="primary-button" onClick={save} disabled={!dlg.values.url.trim()}>
              Save
            </button>
          </div>
        </Modal>
