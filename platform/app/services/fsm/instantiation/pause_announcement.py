...
def get_pause_instruction(language: str) -> str:
    return PAUSE_INSTRUCTIONS.get(language.lower(), PAUSE_INSTRUCTIONS["en"])


def get_paused_announcement(language: str) -> str:
    return PAUSED_ANNOUNCEMENTS.get(language.lower(), PAUSED_ANNOUNCEMENTS["en"])


def get_resuming_announcement(language: str) -> str:
    return RESUMING_ANNOUNCEMENTS.get(language.lower(), RESUMING_ANNOUNCEMENTS["en"])
