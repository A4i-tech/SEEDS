...
class PauseContentEvent(ConferenceEvent):
    def __init__(self, conf_call: ConferenceCall, initiator_phone: str | None = None) -> None:
    ...
    async def execute_event(self) -> None:
        ...
        await ws.send_message(WebsocketServiceMessage(websocket_id=self.conf_call.conf_id, type=MessageType.PAUSE_AUDIO))
