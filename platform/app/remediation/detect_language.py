...
_FILENAME_HINTS: tuple[tuple[tuple[str, ...], str], ...] = (
    (("tripura", "bangla", "bengali", "wb"), "Bengali"),
    (("hindi", "ganit", "vigyan"), "Hindi"),
    (("kannada", "ktbs"), "Kannada"),
    (("tamil", "tn"), "Tamil"),
    (("telugu", "ap", "ts"), "Telugu"),
    (("gujarati",), "Gujarati"),
    (("malayalam", "kerala"), "Malayalam"),
    (("marathi", "maharashtra"), "Marathi"),
    (("odia", "orissa"), "Odia"),
    (("punjabi", "punjab"), "Punjabi"),
    (("assamese", "assam"), "Assamese"),
)


def language_from_filename(source_name: str) -> str | None:
    name = source_name.lower()
    for hints, language in _FILENAME_HINTS:
