#!/usr/bin/env python3
"""
Migration 008 — Normalise comprehension collection field names.
...
Changes:
  ...
  titleAudioPath -> title_audio_path
  themeAudioPath -> theme_audio_path
  __v            -> removed

Idempotent: documents without any camelCase fields are skipped.

Usage:
    python migrations/008_comprehension_snake_case.py [--dry-run] [--mongo-uri URI]
"""
...
def main() -> None:
    ...
    parser = argparse.ArgumentParser(description="Normalise comprehension collection.")
