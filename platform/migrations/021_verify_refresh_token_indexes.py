#!/usr/bin/env python3
"""
Migration 021 — Verify refresh-token collection indexes.
...
Usage:
    python migrations/021_verify_refresh_token_indexes.py [--mongo-uri URI]
...
_create_spec = _ilu.spec_from_file_location(
    "migration_021_create",
    os.path.join(_HERE, "021_refresh_token_indexes.py"),
)
...
def main() -> None:
    parser = argparse.ArgumentParser(
        description="Verify refresh-token collection indexes exist and are used."
    )
