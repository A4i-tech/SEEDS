#!/usr/bin/env python3
"""
Migration 011 — Normalise logentries collection field names.
...
Idempotent: documents without 'requestBody' are already migrated and skipped.

Usage:
    python migrations/011_logentries_snake_case.py [--dry-run] [--mongo-uri URI]
"""
...
def main() -> None:
    ...
    parser = argparse.ArgumentParser(description="Normalise logentries collection.")
