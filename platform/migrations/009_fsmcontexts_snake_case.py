#!/usr/bin/env python3
"""
Migration 009 — Normalise fsmcontexts collection field names.

Changes:
  fsmContextId -> fsm_context_id
  phoneNumbers -> phone_numbers
  __v          -> removed

Idempotent: documents without 'fsmContextId' are already migrated and skipped.

Usage:
    python migrations/009_fsmcontexts_snake_case.py [--dry-run] [--mongo-uri URI]
"""
...
COLLECTION = "fsmcontexts"

_RENAMES = {
    "fsmContextId": "fsm_context_id",
    "phoneNumbers": "phone_numbers",
}
_CAMEL_FIELDS = set(_RENAMES.keys()) | {"__v"}
...
def main() -> None:
    ...
    parser = argparse.ArgumentParser(description="Normalise fsmcontexts collection.")
