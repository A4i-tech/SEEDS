---
name: vibesec
description: Helps Claude write secure web applications. Use when working on any web application or when a user requests a security scan or audit to ensure security best practices are followed.
---
