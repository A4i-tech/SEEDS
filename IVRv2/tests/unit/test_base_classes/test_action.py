...
class TestAction:
    ...
    def json_fix(self, j): j["__module__"] = "tests.unit.test_base_classes.test_action"; return j
    ...
    def test_action_from_json_invalid_class(self):
        ...
        with pytest.raises(AttributeError): Action.from_json({"__class__": "NonExistentClass", "__module__": "tests.unit.test_base_classes.test_action", "attributes": {"test": "value"}})