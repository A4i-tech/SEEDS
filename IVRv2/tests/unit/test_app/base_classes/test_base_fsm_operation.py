...
class TestFSMOperation:
    ...
    def json_fix(self, j): j["__module__"] = "tests.unit.test_app.base_classes.test_base_fsm_operation"; return j
    ...
    def test_fsm_operation_from_json_invalid_class(self):
        ...
        with pytest.raises(AttributeError): FSMOperation.from_json({"__class__": "NonExistentOperation", "__module__": "tests.unit.test_app.base_classes.test_base_fsm_operation", "attributes": {"test": "value"}})