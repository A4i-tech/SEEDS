...
class TestProcessOperationOutput:
    ...
    def json_fix(self, j): j["__module__"] = "tests.unit.test_app.base_classes.test_base_process_operation_output"; return j
    ...
    def test_process_operation_output_from_json_invalid_class(self):
        ...
        with pytest.raises(AttributeError): ProcessOperationOutput.from_json({"__class__": "NonExistentProcessor", "__module__": "tests.unit.test_app.base_classes.test_base_process_operation_output", "attributes": {"test": "value"}})