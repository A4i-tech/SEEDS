...
storage_account_base_url = f"https://{storage_account_name}.blob.core.windows.net/comprehension/"
...
sub_comprehension_evaporation = SubComprehension(
    passage=URLTextEntity(
        url= storage_account_base_url + "Evaporation%20-%20intro%20123%20optionsFINAL.mp3",
    ...
    options=[
        ComprehensionOption(
            ...
            exploreValue=URLTextEntity(
                url=storage_account_base_url + 'Evaporation%20choice%201%20-%20lake.mp3',
        ...
        ComprehensionOption(
            ...
            exploreValue=URLTextEntity(
                url=storage_account_base_url + 'Evaporation%20choice%202%20-%20puddle.mp3',
...
sub_comprehension_condensation = SubComprehension(
    passage=URLTextEntity(
        url=storage_account_base_url + 'Condensation%20-%20intro%20123%20options.mp3',
    ...
    options=[
        ComprehensionOption(
            ...
            exploreValue=URLTextEntity(
                url= storage_account_base_url + 'Condensation%20-%20Choice%201%20-%20field%20of%20crops.mp3',
        ...
        ComprehensionOption(
            ...
            exploreValue=URLTextEntity(
                url= storage_account_base_url + 'Condensation%20-%20Choice%202%20-%20City.mp3',
        ...
        ComprehensionOption(
            ...
            exploreValue=URLTextEntity(
                url= storage_account_base_url + 'Condensation%20-%20Choice%203%20-%20Park.mp3',
...
sub_comprehension_precipitation = SubComprehension(
    passage=URLTextEntity(
        url= storage_account_base_url + 'Precipitation%20-%20intro%20123%20options.mp3',
        text="Now you’re high up in the sky, and it’s getting cooler. The water vapor turns into tiny droplets and forms clouds. This process is called condensation. Let’s continue your journey as a droplet in a cloud. But where do you want to go next?"
    ),
    options=[
        ComprehensionOption(
            ...
            exploreValue=URLTextEntity(
                url= storage_account_base_url + 'Precipitation%20-%20Choice%201%20-%20rain%20over%20garden.mp3',
                text="You joined a big dark cloud over a field of crops. Farmers depend on rain from clouds like this to water their crops. But in some places, people use too much water for farming, and it runs out quickly. That’s why conserving water is so important! Press any key to continue."
            )
        ),
        ComprehensionOption(
            ...
            exploreValue=URLTextEntity(
                url= storage_account_base_url + 'Precipitation%20-%20Choice%202%20-%20Snow%20in%20mountains.mp3',
                text="You joined a small white cloud over a city. In cities, people often use a lot of water in homes, schools, and offices. Collecting rainwater in the city can help save water. Let’s move on to see what happens next. Press any key to continue."
            )
        ),
        ComprehensionOption(
            ...
            exploreValue=URLTextEntity(
                url= storage_account_base_url + 'Precipitation%20-%20choice%203%20-%20rain%20over%20playground.mp3',
                text="You joined a fluffy cloud over a park. Parks need water to keep their grass and plants green. But using sprinklers all day wastes a lot of water. It's better to water plants early in the morning or late at night. Press any key to continue."
            )
        )
    ]
...
sub_comprehension_collection = SubComprehension(
    passage=URLTextEntity(
        url=  storage_account_base_url + 'Collection%20-%20intro%20123%20options.mp3',
        text="Now you’re high up in the sky, and it’s getting cooler. The water vapor turns into tiny droplets and forms clouds. This process is called condensation. Let’s continue your journey as a droplet in a cloud. But where do you want to go next?"
    ),
    options=[
        ComprehensionOption(
            ...
            exploreValue=URLTextEntity(
                url= storage_account_base_url + 'Collection%20-%20choice%201%20-%20cleaning%20the%20house.mp3',
                text="You joined a big dark cloud over a field of crops. Farmers depend on rain from clouds like this to water their crops. But in some places, people use too much water for farming, and it runs out quickly. That’s why conserving water is so important! Press any key to continue."
            )
        ),
        ComprehensionOption(
            ...
            exploreValue=URLTextEntity(
                url= storage_account_base_url + 'Collection%20-%20choice%202%20-%20storing%20the%20water.mp3',
                text="You joined a small white cloud over a city. In cities, people often use a lot of water in homes, schools, and offices. Collecting rainwater in the city can help save water. Let’s move on to see what happens next. Press any key to continue."
            )
        ),
        ComprehensionOption(
            ...
            exploreValue=URLTextEntity(
                url=  storage_account_base_url + 'Collection%20-%20choice%203%20-%20wasting%20the%20water.mp3',
                text="You joined a fluffy cloud over a park. Parks need water to keep their grass and plants green. But using sprinklers all day wastes a lot of water. It's better to water plants early in the morning or late at night. Press any key to continue."
            )
        )
    ]
...
WaterCycleComprehension = ComprehensionData(
    intro=URLTextEntity(
        url= storage_account_base_url + 'Intro%20to%20adventure.mp3',
    ...
    conclusion=URLTextEntity(
        url= storage_account_base_url + 'Conclusion.mp3',
