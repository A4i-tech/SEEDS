...
content_url = f"{storage_account_base_url}output-container/Quiz/Punyakoti/"
comprehension_structure = {
  "comprehension_id": "12345678",
  "id": "45",
  "language": "kannada",
  "title": "Punyakoti",
  "titleAudio": f"{content_url}titleAudio.mp3",
  "localTitle": "ಮೊಲದ ಮರಿ",
  "theme": "water",
  "themeAudio": f"{content_url}themeAudio.mp3",
  "isPullModel": true,
  "isProcessed": true,
  "isTeacherApp": true,
  "__v": 0,
